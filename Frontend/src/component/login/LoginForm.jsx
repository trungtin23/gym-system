...
export default function LoginForm() {
    ...
    const onSubmit = async () => {
        ...
        console.log("🚀 ~ LoginForm ~ pass:", pass)
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div class="space-y-4 md:space-y-6" action="#">
                  <div>
                      ...
                      <input type="email" name="email" onChange={e => (setName(e.target.value))} id="email" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required=""/>
                  </div>
                  <div>
