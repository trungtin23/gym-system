...
export default function HomePage() {
  return (
    <div>
      <title>MaxGym</title>
      {/* Hero Area Start */}
      <section id="hero-area" className="">
        <div className="relative">
          {/* Background image container */}
          <div className="absolute inset-0 bg-[url('/bgGym.jpg')] bg-cover bg-no-repeat bg-center"></div>

          {/* Backdrop layer */}
          <div className="absolute inset-0 bg-black/50 backdrop-blur-none"></div>

          {/* Content container */}
          <div className="relative container px-4 pt-30 pb-90">
            <div className="flex justify-between">
              <div className="w-full text-center">
                <h1 className="text-5xl font-bold leading-snug text-white mb-10 pt-20">
                  THE MAXGYM <br className="hidden lg:block" /> Hệ thống phòng
                  tập số 1 Việt Nam
                </h1>
                <div className="text-center mb-10">
                  <a
                    ...
                    rel="nofollow"
                    className="text-white bg-orange-400 px-10 py-3 rounded-full duration-300 hover:bg-orange-600"
                  >
                    Đăng ký ngay
                  </a>
                </div>
      ...
      <section id="services" className="">
        <div className="container px-4 bg-black/90 py-24">
          <div className="text-center">
            <h2 className="mb-12 text-5xl text-white font-bold tracking-wide">
              Về Chúng Tôi
            </h2>
          </div>
          <div className="flex flex-wrap">
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3">
              <div className="m-4">
                ...
                <div>
                  <h3 className=" text-white font-semibold text-lg block mb-3 uppercase">
                    CHÚNG TÔI LÀ MAXGYM
                  </h3>
                  <p className="text-white">
                    Là thương hiệu về sức khỏe lớn nhất Việt Nam, MaxGym được
                    xây dựng để mang lại hạnh phúc và tạo ra những khoảnh khắc
                    viên mãn cho bạn trong cuộc sống bằng việc cung cấp các dịch
                    vụ phát triển sức khỏe thể chất, dinh dưỡng và tinh thần
                    toàn diện.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-gray-800 py-6 border-t-2 border-gray-700 border-dotted">
        <div className="container px-4">
          <div className="flex flex-wrap">
            <div className="w-full text-center">
              <p className="text-white">
                Designed and Developed by DaoTrungTin
              </p>
            </div>
          </div>
        </div>
